...
void LED_output(void) {
  ...
  if (csFlag.HiBeam == 0 && csFlag.LoBeam == 0 && csFlag.DRL == 0 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((0));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 0 && csFlag.DRL == 0 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((0));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 0 && csFlag.DRL == 1 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((199));
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 0 && csFlag.DRL == 1 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((199));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 1 && csFlag.DRL == 0 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 1 && csFlag.DRL == 0 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 1 && csFlag.DRL == 1 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 0 && csFlag.LoBeam == 1 && csFlag.DRL == 1 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 0 && csFlag.DRL == 0 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM2_LoadDutyValue((0));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 0 && csFlag.DRL == 0 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((0));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 0 && csFlag.DRL == 1 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((199));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 0 && csFlag.DRL == 1 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 0; } while(0);
    EPWM2_LoadDutyValue((199));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 1 && csFlag.DRL == 0 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 1 && csFlag.DRL == 0 && csFlag.RunLight == 1) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 1 && csFlag.DRL == 1 && csFlag.RunLight == 0) {

    do { LATAbits.LATA0 = 1; } while(0);
    EPWM2_LoadDutyValue((499));;
  } else if (csFlag.HiBeam == 1 && csFlag.LoBeam == 1 && csFlag.DRL == 1 && csFlag.RunLight == 1) {
