...
foreach(source_file ${TY1475_RX_default_default_XC8_FILE_TYPE_assemble})
...
# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${TY1475_RX_default_default_XC8_FILE_TYPE_assemblePreprocess})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()
...
set(TY1475_RX_default_image_base_name "default")

# The output directory of the final image.
set(TY1475_RX_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/TY1475_RX")

# The full path to the final image.
set(TY1475_RX_default_full_path_to_image ${TY1475_RX_default_output_dir}/${TY1475_RX_default_image_name})
